...
今回の開発を通して，巨大なソフトウェアを理解するときに，
既存の実装にどのようなユーティリティ関数が用意されているかを把握するのが難しいものであると
実感しました．
小さなソフトウェアであれば，既存のユーティリティ関数を把握するのは容易ですが，
巨大なソフトウェアだと，ユーティリティ関数の数が多くなり，
またどの階層で何がアクセスできる状態になっているかを把握するのが難しくなるのを感じました．

また，TypeScriptのコードの実効フローを理解するために，
Chrome Developer Toolsを用いる方法を学ぶことができました．
Chrome Developer Toolsを用いることで，
ブレークポイントを設定したり，コールスタックを確認したり，変数の中身の確認を行うことができ，フローの理解が容易になりました．

加えてvscodeはGUIアプリケーションであり，
普段の開発においてはC++のCUIアプリケーションを扱うことが多いため，
GUIアプリケーションの開発およびデバッグ手法を学ぶ良い機会になり，
TypeScriptにおける型システムや非同期処理の扱い方についても理解を深めることができました．
